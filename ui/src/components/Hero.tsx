...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div
      className="relative w-full h-auto flex items-center justify-center py-24 md:min-h-[75vh]"
      id={id}
    >
      <Image
        src={backgroundImage}
      ...
      {video ? (
        <div className="relative z-10 text-start flex items-center gap-10 w-full max-w-7xl h-full">
